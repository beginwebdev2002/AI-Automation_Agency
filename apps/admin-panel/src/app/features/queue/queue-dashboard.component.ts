  ...
  template: `
    <div class="min-h-screen bg-gray-50 p-6">
      <div class="flex justify-between items-center mb-10 max-w-6xl mx-auto">
        <h1 class="text-4xl font-serif text-medical-rose-900" i18n="@@liveQueueTitle">Live Queue</h1>
      ...
      <div class="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-lg border-l-8 border-medical-gold-500">
          <h2 class="text-2xl font-medium text-gray-500 mb-6" i18n="@@nowServingLabel">Now Serving</h2>
        ...
        <div class="bg-white p-8 rounded-3xl shadow-sm">
          <h2 class="text-2xl font-medium text-gray-500 mb-6" i18n="@@upNextLabel">Up Next</h2>
          <div class="space-y-4">
