    ...
    <div class="min-h-screen bg-gray-50 p-6">
      ...
      <div class="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-lg border-l-8 border-medical-gold-500">
          ...
          @if (!current()) {
            <div class="text-center text-gray-400 py-10" i18n="@@waitingForNextPatient">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-sm">
          ...
          <div class="space-y-4">
            @for (item of waiting(); track item._id) {
            ...
            @if (waiting().length === 0) {
              <div class="text-center text-gray-400 py-4" i18n="@@queueEmpty">
                Очередь пуста
              </div>
            }
          </div>
