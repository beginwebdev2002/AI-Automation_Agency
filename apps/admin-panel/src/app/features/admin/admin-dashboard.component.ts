  ...
  template: `
    <div class="min-h-screen bg-gray-100 p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm">
          <h3 class="text-gray-500 text-sm font-medium uppercase">Telegram Revenue</h3>
          <p class="text-3xl font-bold text-green-600 mt-2">{{ stats().revenue }} TJS</p>
        </div>
        <div class="bg-white p-6 rounded-2xl shadow-sm">
          <h3 class="text-gray-500 text-sm font-medium uppercase">Active Queue</h3>
      ...
      <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-100">
          <h2 class="text-xl font-bold text-gray-800">Queue Management</h2>
        </div>
