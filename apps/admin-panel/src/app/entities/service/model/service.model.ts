...
export const MOCK_SERVICES: Service[] = [
  ...
  // Injectables
  { id: 'i_botox_1', name: 'Ботокс: Лоб', category: 'Injectables', price: 1200 },
  { id: 'i_botox_2', name: 'Ботокс: Межбровье', category: 'Injectables', price: 1200 },
  { id: 'i_botox_3', name: 'Ботокс: Глаза ("Гусиные лапки")', category: 'Injectables', price: 1200 },
  { id: 'i_bio_1', name: 'Биоревитализация: Лицо (Basic)', category: 'Injectables', price: 1200 },
  { id: 'i_bio_2', name: 'Биоревитализация: Лицо (Premium)', category: 'Injectables', price: 2500 },
  { id: 'i_plasm_1', name: 'Плазмолифтинг (PRP)', category: 'Injectables', price: 250 },

  // Facials
  { id: 'f_1', name: 'Чистка лица "12 этапов"', category: 'Facials', price: 150 },
